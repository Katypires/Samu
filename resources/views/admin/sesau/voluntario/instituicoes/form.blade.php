                <div class="row">
                    <div class="mb-4 col-4">
                        ...
                        <livewire:admin.sesau.voluntario.dropdown-component key="{{Str::random(5)}}"  columnName="nome" columnId="id" titulo="Tipo Atividade" model="App\Models\Admin\Sesau\Voluntario\TipoAtividade" label="tipo_atividade_id" value="{{ isset($data['tipo_atividade_id']) ? $data['tipo_atividade_id'] : '0' }}"  />
