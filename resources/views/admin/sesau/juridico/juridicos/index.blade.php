...
@section('content')
<livewire:admin.card.modal-component key="1" title="TipoFuncaoPessoa" icon="fas fa-mobile-alt icon"  form="admin.sesau.juridico.tipo_funcao_pessoas.form" modalId="TipoFuncaoPessoa" tamanho="modal-fullscreen" icon="fas fa-map-marker-alt icon"/>
<livewire:admin.card.modal-component key="1" title="TipoFuncaoMembro" icon="fas fa-mobile-alt icon"  form="admin.sesau.juridico.tipo_funcao_membros.form" modalId="TipoFuncaoMembro" tamanho="modal-fullscreen" icon="fas fa-map-marker-alt icon"/>
...
<div class="card p-4 mb-4">            
    <div class="row">
        <livewire:admin.card.card-component key="1" title="App" text_color='text-white' text="teste texto" icon="fas fa-mobile-alt icon" cor="bg-primary" link="" /> 
        <livewire:admin.card.card-component key="2" title="Site" text_color='text-white' text="teste texto" icon="fas fa-globe icon" cor="bg-success" link=''>
