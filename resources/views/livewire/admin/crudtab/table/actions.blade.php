@if($formType == 'form')
    ...
    <button  class="btn btn-outline-primary"  wire:click=""><i class="fa fa-file-text"></i> Visualize</button>
    <button class="btn btn-outline-danger"><i class="fas fa-print"></i>Imprima</button>
    @endif
