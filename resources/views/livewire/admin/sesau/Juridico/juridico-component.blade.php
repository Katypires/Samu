...
<livewire:admin.card.modal-component key="{{Str::random(5)}}" title="Pessoa" icon="fas fa-mobile-alt icon"  form="admin.sesau.juridico.sindicancia.form_sindicancia" modalId="Sindicancia" tamanho="modal-fullscreen" icon="fas fa-map-marker-alt icon"/>
...
<div class="card p-4 mb-4">            
    <div class="row">
        ...
        <livewire:admin.crud.crud-component key="{{Str::random(5)}}" formType="form" modal="Oitiva" title="Oitiva" model="App\Models\Admin\Sesau\Juridico\Oitiva" form="admin.sesau.juridico.oitiva.form_oitiva" />
