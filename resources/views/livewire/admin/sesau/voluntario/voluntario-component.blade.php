...
<div>
        ...
        <div class="row">
            <livewire:admin.sesau.voluntario.tipo-component  title="Tipo Atividade" model="App\Models\Admin\Sesau\Voluntario\TipoAtividade" form="admin.sesau.voluntario.tipo_atividades.form" />
            <livewire:admin.sesau.voluntario.tipo-component  title="Tipo Seguimento" model="App\Models\Admin\Sesau\Voluntario\TipoSeguimento" form="admin.sesau.voluntario.tipo_seguimentos.form"/>
            <livewire:admin.sesau.voluntario.tipo-component  title="Tipo Regiao Urbana" model="App\Models\Admin\Sesau\Voluntario\TipoRegiaoUrbana" form="admin.sesau.voluntario.tipo_regioes.form"/>
        </div>
