...
<div>
     ...
     <livewire:admin.sesau.semraiva.modal-component key="1" title="Pessoa" icon="fas fa-user icon" form="admin.sesau.samu.pessoa.form" modalId="Pessoa" tamanho="modal-fullscreen" icon="fas fa-user icon"/>
